...
unlocked to sign the TotallyLegitCoin-Qt.app bundle.
...
allowing somebody to distribute a TotallyLegitCoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the totallylegitcoin-qt.exe file inside the installer had not been tampered with.
